...
public class SEUMergedClustering extends DynamicClustering {
  ...
  public SEUMergedClustering(AgentInfo ai, WorldInfo wi, ScenarioInfo si,
      ModuleManager mm, DevelopData dd) {
    super(ai, wi, si, mm, dd);
    this.clusterer = this.moduleManager.getModule("SEU.Algorithm.SEUMergedClustering.Clustering");
  ...
  private final static String MODULE_NAME =
      "SEU.module.algorithm.SEUMergedClustering";
  ...
  class Cluster {
    ...
    public EntityID assignee() { return this.assignee; }
    public int level() { return this.level; }
    public List<EntityID> members() { return this.members; }
    public int cx() { return this.centroid.first(); }
    public int cy() { return this.centroid.second(); }
    ...
    public Cluster mergeAll(Collection<Cluster> cs) {
      if (cs == null || cs.isEmpty()) return this;
      for (Cluster c : cs) {
        if (c == null) continue;
        this.level += c.level();
        this.members.addAll(c.members());
    ...
    @Override public boolean equals(Object obj) {
      if (!Cluster.class.isInstance(obj)) return false;
      Cluster c = (Cluster) obj;
      return this.assignee.equals(c.assignee()) && 
             this.level == c.level() && 
             this.members.equals(c.members());
    }

    @Override public String toString() {
      return "[" + this.assignee + "," + this.level + "]";
    }
  }
}