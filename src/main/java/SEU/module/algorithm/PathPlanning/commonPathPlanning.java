...
public class commonPathPlanning extends PathPlanning {
    ...
    public commonPathPlanning(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
